...
<div class="col-sm-8">
 ...
 <asp:DataList ID="DataList1" runat="server" DataKeyField="PId" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" CssClass="datalistinfo" OnItemCommand="DataList1_ItemCommand" Font-Bold="True">
    <ItemTemplate>
 ...
 <asp:DataList ID="DataList2" runat="server" Visible="false" RepeatColumns="3" RepeatDirection="Horizontal">
   <ItemTemplate>
   <asp:Label ID="id" runat="server" Text='<%# Eval("PId") %>' Visible="false" ></asp:Label>
