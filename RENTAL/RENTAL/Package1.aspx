<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Package1.aspx.cs" Inherits="RENTAL.Package1"  EnableEventValidation="false" ValidateRequest="false"%>
...
<!-- Modal Popup -->
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails" SelectCommandType="StoredProcedure">
                  <SelectParameters>
                      ...
                      <asp:Parameter DefaultValue="Package" Name="PCategory" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
