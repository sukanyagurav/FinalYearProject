<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Bed1.aspx.cs" Inherits="RENTAL.Bed1" %>
...
<div class="col-sm-8">
 ...
 <asp:DataList ID="DataList1" runat="server" DataKeyField="PId" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" CssClass="datalistinfo" OnItemCommand="DataList1_ItemCommand" Font-Bold="True" OnItemDataBound="DataList1_ItemDataBound">
    <ItemTemplate>
        ...
        <br />
        PKeyword:
        <asp:Label ID="PKeywordLabel" runat="server" Text='<%# Eval("PKeyword") %>' />
        <br />
        PCategory:
        ...
        <br />
        RefundableDeposit:
        <asp:Label ID="RefundableDepositLabel" runat="server" Text='<%# Eval("RefundableDeposit") %>' />
        <br />
        CityId:
        ...
        <br />
        PId1:
        <asp:Label ID="PId1Label" runat="server" Text='<%# Eval("PId1") %>' />
        <br />
        CityId1:
        <asp:Label ID="CityId1Label" runat="server" Text='<%# Eval("CityId1") %>' />
        <br />
        PQty:
        <asp:Label ID="PQtyLabel" runat="server" Text='<%# Eval("PQty") %>' />
        <br />
        SoldOut:
        <asp:Label ID="SoldOutLabel" runat="server" Text='<%# Eval("SoldOut") %>' />
        <br />
        CityId2:
        <asp:Label ID="CityId2Label" runat="server" Text='<%# Eval("CityId2") %>' />
        <br />
        CityName:
...
<!-- Modal Popup -->
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails1" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="CityName" SessionField="CityName" Type="String" DefaultValue="" />
