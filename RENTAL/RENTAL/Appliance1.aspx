<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Appliance1.aspx.cs" Inherits="RENTAL.Appliance1" EnableEventValidation="false" ValidateRequest="false" %>
           ...
           <!-- modal body -->
            <div class="modal-body">
                 <div class="row">
                  ...
                  <div class="row">
                      <div class="col">
                           <asp:TextBox runat="server" ID="txtreview"  TextMode="MultiLine" class="styled" onfocus="this.value=''; setbg('#e5fff3');" onblur="setbg('white')"></asp:TextBox>
                           <br />
