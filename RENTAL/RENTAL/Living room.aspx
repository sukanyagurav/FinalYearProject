...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <br />
    ...
    <br />
      <br />
    <br />
    <asp:DataList ID="DataList1" runat="server" DataKeyField="PId" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" CssClass="datalistinfo">
        <ItemTemplate>
               <div class="datalist">
            <div class="imagecss">
          ...
          <h3>
              Price:<span>  <asp:Label ID="PPriceLabel" runat="server" Text='<%# Eval("PPrice") %>'  /> </span></h3>
                  <br />
               </div>
