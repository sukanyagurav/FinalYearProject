<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Living room.aspx.cs" Inherits="RENTAL.Living_room"  EnableEventValidation="false" ValidateRequest="false" %>
           ...
           <!-- modal body -->
            <div class="modal-body">
                 <div class="row">
                  ...
                  <div class="row">
                      <div class="col">
                           <asp:TextBox runat="server" ID="txtreview"  TextMode="MultiLine" class="styled" onfocus="this.value=''; setbg('#ffede5');" onblur="setbg('white')"></asp:TextBox>
                           <br />
                           <asp:Button runat="server" Text="Submit Review" CssClass="review" ID="btnsubmit" OnClick="btnsubmit_Click" ValidationGroup="pop" CausesValidation="False" />
                           <br /><asp:Label ID="Label1" runat="server" class="del" ForeColor="Red"></asp:Label>      
                      </div>
                  </div>
                  </div>    
                  </div>
...
<!-- Modal Popup -->
    ...
    <script type="text/javascript">
        function setbg(color) {
            document.getElementByClass("styled").style.background = color
        }
        </script>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails" SelectCommandType="StoredProcedure">
                  <SelectParameters>
                      ...
                      <asp:Parameter DefaultValue="Living Room" Name="PCategory" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
