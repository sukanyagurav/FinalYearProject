<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Study room.aspx.cs" Inherits="RENTAL.Study_room" %>
...
<!-- Modal Popup -->
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails" SelectCommandType="StoredProcedure">
                  <SelectParameters>
                      ...
                      <asp:Parameter DefaultValue="studyroom" Name="PCategory" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
