<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Study room.aspx.cs" Inherits="RENTAL.Study_room" EnableEventValidation="false" ValidateRequest="false"%>
...
<!-- Modal Popup -->
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails" SelectCommandType="StoredProcedure">
                  <SelectParameters>
                      ...
                      <asp:Parameter DefaultValue="Study Room" Name="PCategory" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
