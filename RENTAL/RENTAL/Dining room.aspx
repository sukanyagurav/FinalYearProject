<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Dining room.aspx.cs" Inherits="RENTAL.Dining_room" %>
...
<div id="MyPopup" class="modal fade productview" role="dialog">
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                 ...
                 <div class="col-md-6 product_content">
                       <h2>
                      <asp:Label ID="namep" runat="server" ValidationGroup="pop"></asp:Label>
                      </h2>  
                   
                     <h3 class="cost">Price:
                      <asp:Label ID="price" runat="server"  Visible="true" ValidationGroup="pop"></asp:Label>
                      <asp:Label ID="ddlprice" runat="server" Visible="false" ValidationGroup="pop"></asp:Label>
                      </h3>
                        <div class="row">
...
<!-- Modal Popup -->
  ...
  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="GetProductDetails" SelectCommandType="StoredProcedure">
                  <SelectParameters>
                      ...
                      <asp:Parameter DefaultValue="diningroom" Name="PCategory" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
