<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="RENTAL.search"  EnableEventValidation="false" ValidateRequest="false"  %>
...
font-size:14px;
 ...
 font-family: "Verdana";
  ...
  <asp:DataList runat="server"  RepeatColumns="3" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand" Font-Bold="True" OnItemDataBound="DataList1_ItemDataBound" ID="DataList1" DataKeyField="PId" DataSourceID="SqlDataSource1" >
              <ItemTemplate>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SearchProduct" SelectCommandType="StoredProcedure">
         <SelectParameters>
             <asp:QueryStringParameter Name="search" QueryStringField="search" Type="String" />
             <asp:SessionParameter Name="CityName" SessionField="cityId" Type="String" />
         </SelectParameters>
     </asp:SqlDataSource>
